...
class iv.view.Ctrls extends mx.core.UIComponent {
	...
	var text_lb_file_path:TextField;
	...
	function onLoad() {
		...
		//demo special init call
		/////////////////////////////////////////		
		_itv_init_Demo = setInterval(this, 'itv_init_Demo', 3000);
		//btn_load.enabled = false;
		btn_load.visible = false;
		text_lb_file_path._visible = false;
		text_path.visible = false;
		//itv_init_Demo();
	}
	private var _itv_init_Demo;
	function itv_init_Demo() {
		trace("initDemo");
		clearInterval(_itv_init_Demo);
		btn_load_onClick();
	}
	function scroll() {
